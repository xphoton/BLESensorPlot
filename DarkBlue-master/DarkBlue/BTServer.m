...
-(void)setNotificationYes:(CBCharacteristic*)characteristic
{
    self.selectCharacteristic = characteristic;
    [self.selectPeripheral setNotifyValue:YES forCharacteristic:self.selectCharacteristic];
}

-(void)setNotificationNo:(CBCharacteristic*)characteristic
{
    self.selectCharacteristic = characteristic;
    [self.selectPeripheral setNotifyValue:NO forCharacteristic:self.selectCharacteristic];
}
